...
Gender, age, and the measured Vit D serum levels (before and after treatment) are possible confounding factors that can be added to the model.
...
First we check whether there was a genuine need to adjust for the experimental individuals. We do this by testing for differential expression between the individuals. There is considerable differential expression, justifying our decision to adjust for the batch effect:
